...
/* ✅ FIX: use student_id from URL */
if(isset($_GET['student_id'])){
    $other_id = $_GET['student_id'];
}else{
    die("User ID missing");
}
...
WHERE (sender_id=$student_id AND receiver_id=$other_id)
OR (sender_id=$other_id AND receiver_id=$student_id)
ORDER BY created_at ASC
");

while($m = mysqli_fetch_assoc($result)){

$class = ($m['sender_id']==$student_id) ? 'student-msg' : 'admin-msg';
